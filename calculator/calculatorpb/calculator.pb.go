...
func (x *FindMaxiumRequest) Reset() {
	*x = FindMaxiumRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *FindMaxiumRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FindMaxiumRequest) ProtoMessage() {}

func (x *FindMaxiumRequest) ProtoReflect() protoreflect.Message {
	mi := &file_calculator_calculatorpb_calculator_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FindMaxiumRequest.ProtoReflect.Descriptor instead.
func (*FindMaxiumRequest) Descriptor() ([]byte, []int) {
	return file_calculator_calculatorpb_calculator_proto_rawDescGZIP(), []int{6}
}

func (x *FindMaxiumRequest) GetNumber() int32 {
	if x != nil {
		return x.Number
	}
	return 0
...
type FindMaxiumResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Maxium int32 `protobuf:"varint,1,opt,name=maxium,proto3" json:"maxium,omitempty"`
}

func (x *FindMaxiumResponse) Reset() {
	*x = FindMaxiumResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *FindMaxiumResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FindMaxiumResponse) ProtoMessage() {}

func (x *FindMaxiumResponse) ProtoReflect() protoreflect.Message {
	mi := &file_calculator_calculatorpb_calculator_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FindMaxiumResponse.ProtoReflect.Descriptor instead.
func (*FindMaxiumResponse) Descriptor() ([]byte, []int) {
	return file_calculator_calculatorpb_calculator_proto_rawDescGZIP(), []int{7}
}

func (x *FindMaxiumResponse) GetMaxium() int32 {
	if x != nil {
		return x.Maxium
	}
	return 0
...
var file_calculator_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x2b, 0x0a, 0x11, 0x46, 0x69, 0x6e, 0x64, 0x4d, 0x61, 0x78, 0x69, 0x75, 0x6d, 0x52,
	...
	0x0a, 0x12, 0x46, 0x69, 0x6e, 0x64, 0x4d, 0x61, 0x78, 0x69, 0x75, 0x6d, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x6d, 0x61, 0x78, 0x69, 0x75, 0x6d, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x6d, 0x61, 0x78, 0x69, 0x75, 0x6d, 0x22, 0x2b, 0x0a, 0x11,
	...
	0x32, 0xc7, 0x03, 0x0a, 0x11, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x53,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x51, 0x0a, 0x0a, 0x46, 0x69, 0x6e, 0x64,
	0x4d, 0x61, 0x78, 0x69, 0x75, 0x6d, 0x12, 0x1d, 0x2e, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61,
	0x74, 0x6f, 0x72, 0x2e, 0x46, 0x69, 0x6e, 0x64, 0x4d, 0x61, 0x78, 0x69, 0x75, 0x6d, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e, 0x2e, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74,
	0x6f, 0x72, 0x2e, 0x46, 0x69, 0x6e, 0x64, 0x4d, 0x61, 0x78, 0x69, 0x75, 0x6d, 0x52, 0x65, 0x73,
...
var file_calculator_calculatorpb_calculator_proto_goTypes = []interface{}{
	...
	(*FindMaxiumRequest)(nil),                // 6: calculator.FindMaxiumRequest
	(*FindMaxiumResponse)(nil),               // 7: calculator.FindMaxiumResponse
...
var file_calculator_calculatorpb_calculator_proto_depIdxs = []int32{
	...
	6, // 3: calculator.CalculatorService.FindMaxium:input_type -> calculator.FindMaxiumRequest
	...
	7, // 8: calculator.CalculatorService.FindMaxium:output_type -> calculator.FindMaxiumResponse
...
func file_calculator_calculatorpb_calculator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_calculator_calculatorpb_calculator_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FindMaxiumRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_calculator_calculatorpb_calculator_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FindMaxiumResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type CalculatorServiceClient interface {
	...
	FindMaxium(ctx context.Context, opts ...grpc.CallOption) (CalculatorService_FindMaxiumClient, error)
	// error handling
...
func (c *calculatorServiceClient) FindMaxium(ctx context.Context, opts ...grpc.CallOption) (CalculatorService_FindMaxiumClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CalculatorService_serviceDesc.Streams[2], "/calculator.CalculatorService/FindMaxium", opts...)
	if err != nil {
		return nil, err
	}
	x := &calculatorServiceFindMaxiumClient{stream}
	return x, nil
}

type CalculatorService_FindMaxiumClient interface {
	Send(*FindMaxiumRequest) error
	Recv() (*FindMaxiumResponse, error)
	grpc.ClientStream
}

type calculatorServiceFindMaxiumClient struct {
	grpc.ClientStream
}

func (x *calculatorServiceFindMaxiumClient) Send(m *FindMaxiumRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *calculatorServiceFindMaxiumClient) Recv() (*FindMaxiumResponse, error) {
	m := new(FindMaxiumResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type CalculatorServiceServer interface {
	...
	FindMaxium(CalculatorService_FindMaxiumServer) error
	// error handling
	// this RPC will throw an exception if the send number is negative
	// The error being send it of type INVALID_ARGUMENT
...
func (*UnimplementedCalculatorServiceServer) FindMaxium(CalculatorService_FindMaxiumServer) error {
	return status.Errorf(codes.Unimplemented, "method FindMaxium not implemented")
}
...
func _CalculatorService_FindMaxium_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CalculatorServiceServer).FindMaxium(&calculatorServiceFindMaxiumServer{stream})
}

type CalculatorService_FindMaxiumServer interface {
	Send(*FindMaxiumResponse) error
	Recv() (*FindMaxiumRequest, error)
	grpc.ServerStream
}

type calculatorServiceFindMaxiumServer struct {
	grpc.ServerStream
}

func (x *calculatorServiceFindMaxiumServer) Send(m *FindMaxiumResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *calculatorServiceFindMaxiumServer) Recv() (*FindMaxiumRequest, error) {
	m := new(FindMaxiumRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
var _CalculatorService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "FindMaxium",
			Handler:       _CalculatorService_FindMaxium_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
